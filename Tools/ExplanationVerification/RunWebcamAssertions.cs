if (UnityEditor.EditorApplication.isPlaying) throw new System.Exception("Run direct webcam fixtures in Edit mode.");
var reports=new System.Collections.Generic.List<object>();
foreach(string suite in new[]{"FaaWebcamGestureTests","FaaSpatialWorkspaceTests","FaaRotorcraftConformalTests","FaaPitchLadderTests","FaaHudStabilityTests","FaaViewAlignmentTests","FaaScreenCueTests","FaaCueStabilityTests","XPlaneEngineHudBindingTests","FaaRadarSettingsTests","FaaRadarPresentationTests"})
{
