...
cp "$ROOT/Tools/XR3/Start-Fallback-Tunnel.cmd" "$OUTPUT/Start-Fallback-Tunnel.cmd"
cp "$ROOT/Tools/XR3/Start-Fallback-Tunnel.ps1" "$OUTPUT/Start-Fallback-Tunnel.ps1"
cp "$ROOT/docs/AUTOMATIC_XPLANE_SOURCES.md" "$OUTPUT/AUTOMATIC-DATA-SOURCES.md"
cp "$ROOT/docs/REFERENCE_VSI.md" "$OUTPUT/VERTICAL-SPEED-REFERENCE.md"
