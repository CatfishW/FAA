...
namespace VisualUnderstanding.Editor
{
    ...
    public class VisualUnderstandingSetupEditor : EditorWindow
    {
        ...
        private void CreateUI(VisionSettings settings)
        {
            ...
            // Size
            panelRect.sizeDelta = new Vector2(350, 400);
            ...
            summaryRect.pivot = new Vector2(0.5f, 1);
            summaryRect.anchoredPosition = new Vector2(0, -75);
            summaryRect.sizeDelta = new Vector2(-20, 200);
            
            var summaryTextGO = CreateTextObject("Summary Text", summaryGO.transform, "", 14);
            var summaryTextRect = summaryTextGO.GetComponent<RectTransform>();
            ...
            var findingsRect = findingsGO.AddComponent<RectTransform>();
            findingsRect.anchorMin = new Vector2(0, 0);
            findingsRect.anchorMax = new Vector2(1, 0.5f);
            findingsRect.pivot = new Vector2(0.5f, 0.5f);
            findingsRect.offsetMin = new Vector2(10, 10);
            findingsRect.offsetMax = new Vector2(-10, -10);
