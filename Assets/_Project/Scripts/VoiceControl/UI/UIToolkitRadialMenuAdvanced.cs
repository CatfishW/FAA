...
namespace VoiceControl.UI
{
    ...
    public class UIToolkitRadialMenuAdvanced : MonoBehaviour
    {
        ...
        [SerializeField] private float middleRadius = 320f;
        [SerializeField] private float outerRadius = 465f;
        [SerializeField] private bool enableSubMenus = true;
        [SerializeField] private bool startCollapsed = true;
        [SerializeField] private float collapsedButtonSize = 68f;
        [SerializeField] private Vector2 collapsedButtonPosition = new Vector2(72f, 72f);  // Bottom-left offset
        ...
        private const float MainSegmentWidth = 190f;
        private const float MainSegmentHeight = 104f;
        private const float SubSegmentWidth = 150f;
        private const float SubSegmentHeight = 84f;
        private const float MainIconContainerSize = 62f;
        private const float MainIconSize = 52f;
        private const float SubIconContainerSize = 42f;
        private const float SubIconSize = 32f;
        ...
        private static readonly Color PanelBackgroundColor = new Color(0.02f, 0.025f, 0.03f, 0.94f);
        private static readonly Color SegmentBackgroundColor = new Color(0.035f, 0.055f, 0.06f, 0.95f);
        private static readonly Color SegmentBorderColor = new Color(0.18f, 0.95f, 0.72f, 0.38f);
        private static readonly Color SubBorderBaseColor = new Color(0.30f, 0.85f, 0.70f, 0.32f);
        ...
        private const float CenterSizePadding = 46f;
        ...
        private void ApplyInlineStyles()
        {
            ...
            float ringSize = middleRadius * 2 + 64;
            ...
            SetBorderWidth(_ringBackground, 2);
            SetBorderColor(_ringBackground, new Color(0.15f, 0.95f, 0.70f, 0.36f * menuTransparency));
            ...
            foreach (var seg in _mainSegments)
            {
                ...
                SetBorderWidth(seg.Container, 2);
                ...
                seg.Background.style.backgroundColor = new Color(0.04f, 0.11f, 0.10f, 0.24f);
        ...
        public void ApplyAviationHudPreset(bool refresh = true)
        {
            ...
            middleRadius = 320f;
            outerRadius = 465f;
            collapsedButtonSize = 68f;
            collapsedButtonPosition = new Vector2(72f, 72f);
            ...
            menuTransparency = 0.92f;
            ringBackgroundTransparency = 0.82f;
            segmentTransparency = 0.94f;
            centerTransparency = 0.94f;
