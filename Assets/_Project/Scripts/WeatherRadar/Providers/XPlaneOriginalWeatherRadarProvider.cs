...
namespace WeatherRadar
{
    ...
    public class XPlaneOriginalWeatherRadarProvider : WeatherRadarProviderBase
    {
        ...
        [SerializeField] private float minimumRefreshIntervalSeconds = 0.25f;
        ...
        private float _lastRequestRealtime = -999f;
        ...
        public Texture2D CurrentTexture => radarTexture;
        ...
        protected override void GenerateRadarData()
        {
            ...
            if (now - _lastRequestRealtime < Mathf.Max(0.05f, minimumRefreshIntervalSeconds))
            {
                isGenerating = false;
                return;
            }
            ...
            _downloadCoroutine = StartCoroutine(DownloadOriginalTexture(++_requestSequence));
        }
        ...
        public void PublishTexture(Texture2D texture, bool takeOwnership = false)
        {
            if (texture == null)
            {
                isGenerating = false;
            ...
            ReplaceRadarTexture(takeOwnership ? texture : CopyTexture(texture));
        ...
        private IEnumerator DownloadOriginalTexture(int requestSequence)
        {
